...
{
    public class ExpenseReport : BaseReport, IReport
    {
        Dictionary<string, string> headerTokenMap;
        StringBuilder report;

        public ExpenseReport() : base(new ReportController())
        {
        ...
        public void LoadData()
        {
            ...
            foreach (Expense entity in Controller.GetExpensesByDateRange(ReportType, StartDate, EndDate, ActiveUser.id))
            {
                reportData.Rows.Add(entity.Source, entity.Amount);
            }
        }
    }
}
